...
def main():
    ...
    if args.format == "csv":
        ...
        with open(args.out, "w", encoding="utf-8") as f:
            ...
            f.write("from melody_features.quarto_table_build import build_table\n\n")
            ...
            f.write("- **IDyOM**: Pearce, M. T. (2005). The construction and evaluation of statistical models of melodic structure\n")
