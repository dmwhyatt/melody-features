#!/usr/bin/env python3
"""
Test runner script for the melodic_feature_set package.
Runs all pytest tests and doctests with proper configuration.
"""
...
def run_tests():
    ...
    logger.info("Running all tests for melodic_feature_set...")
    ...
    cmd = [
        ...
        "--doctest-modules", "src/", # Run doctests in src/
        "-v",                        # Verbose output
